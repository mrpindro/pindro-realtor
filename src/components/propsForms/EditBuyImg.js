...
import axiosApi, { getSellingProps, postSellingProps } from '../../api/axiosApi';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (images) {
                ...
                const response = await axiosApi.put(`${postSellingProps}/${id}`, formData, {
        ...
        <main className='main-con create-buy-main'>
            ...
            <div className="props-form-con">
                ...
                >
                    ...
                    <h3>Updating Images of Property for Sale</h3>
                    ...
                    <div className="form-file-grp flex-col">
                        ...
                        />
                        <label htmlFor="edit-buy-images" className='file-label flex-col'
